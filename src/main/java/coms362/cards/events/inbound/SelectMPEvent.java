...
public class SelectMPEvent implements Event, EventFactory, SysEvent{

    public static final String kId = "SelectMPEvent";
    private String socket = "";
   
    public static Event createEvent(SocketMessage sktEvent) {
        return new SelectMPEvent(sktEvent);
    }
    
    public SelectMPEvent(SocketMessage e) {
