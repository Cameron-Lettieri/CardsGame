...
public class ThreePlayerEvent implements Event, EventFactory, SysEvent{

    public static final String kId = "ThreePlayerEvent";
    private String socket = "";
   
    public static Event createEvent(SocketMessage sktEvent) {
        return new ThreePlayerEvent(sktEvent);
    }
    
    public ThreePlayerEvent(SocketMessage e) {
